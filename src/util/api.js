...
// import { seasonFormat } from '/server/api-util/lineItemHelpers.js';	
...
export const transactionLineItems = body => {
  ...
  const unitPrice = calculatePricingSystem(bookingStart, bookingEnd, 100, season);
...
const seasonFormat = ( startDateHigh, endDateHigh, percenteHigh, startDateMedium, endDateHighMedium, percenteMedium, startDateLower, endDateLower, percenteLower) => {
...
const calculatePricingSystem = (startDate, endDate , basePrice, seasons) => {
